...
**Tier 3: Low Confidence (below 70% certain)**
...
Low confidence: Similar questions have below 80% accuracy or no history
...
If accuracy is below 70%, you need to lower confidence thresholds (express more uncertainty).
...
If under 20% could have been answered, your threshold is well-calibrated.

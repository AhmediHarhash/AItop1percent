...
In October 2025, a conversational AI team at a healthcare company launched a patient intake assistant trained entirely on synthetic dialogue data. The data looked clean in offline evals. Fluency was high, instruction-following was strong, and the responses passed safety checks. In production, the assistant struggled with edge cases.

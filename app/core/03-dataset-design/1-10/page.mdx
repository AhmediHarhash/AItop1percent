...
In June 2025, a customer support automation platform serving a logistics company discovered that its response quality had degraded by eighteen percent over three months. Despite no changes to the underlying model or prompt engineering. The degradation was invisible in their evaluation suite.

The evaluation suite consisted of four hundred carefully curated examples collected during the initial build phase in early 2024. The team ran their nightly eval runs, saw consistent scores in the mid-nineties, and assumed the system was stable.

Meanwhile, customer satisfaction scores dropped week over week. Support ticket volume increased. The operations team began routing more inquiries back to human agents.

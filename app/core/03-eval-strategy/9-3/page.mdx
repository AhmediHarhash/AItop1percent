...
Context: the retrieved_context placeholder
Claim: the claim placeholder
...
Response: the generated_response placeholder
Rating:
```
...
**Judge model limitations**: weaker models (GPT-3.5, Claude Opus 4.5) have lower agreement with human raters on nuanced faithfulness cases. Opus-class models are more reliable but more expensive.

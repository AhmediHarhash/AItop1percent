...
A fast, cheap model (GPT-5-mini, Claude Haiku, Gemini Flash) evaluates every response against a rubric. Scores are logged. Outliers are flagged for human review.

...
**GPT-5, Claude Opus 4.5, or similar frontier models** are most accurate. They understand nuance, handle complex contexts, follow instructions well. Use for high-stakes domains where accuracy matters more than cost.

**GPT-5-mini, Claude Opus 4.5 Haiku, or similar efficient models** are faster and cheaper with slight accuracy drop. Use for high-volume production evals where you're checking thousands of responses per day.
...
- **Best for strict grounding:** Claude Opus 4.5, GPT-5, Gemini 1.5 Pro
- **Good balance of grounding and fluency:** GPT-5-mini, Claude Opus 4.5 Haiku

...
```yaml
user: |
  Response A: the response_a placeholder
  Response B: the response_b placeholder
...
- **Post-model-update recalibration**: When your judge model updates (GPT-5.1 to GPT-5, Claude Opus 3 to Opus 4), recalibrate immediately. Biases and scoring patterns may have changed.
...
- **GPT-5.1 judge**: Scores all responses 1-10

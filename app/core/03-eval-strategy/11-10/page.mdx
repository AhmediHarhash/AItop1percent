...
Example patterns:
- Email: a pattern matching alphanumeric characters and allowed symbols, followed by an at-sign, a domain name, a dot, and a top-level domain of two or more letters
- Phone: a pattern matching an optional opening parenthesis, three digits, an optional closing parenthesis, an optional separator, three more digits, another separator, and four final digits
- SSN: a pattern matching three digits, a hyphen, two digits, another hyphen, and four final digits

...
Run two or three different judge models (e.g., GPT-5, Claude Opus, Gemini 1.5 Pro). If they agree, confidence is high. If they disagree, confidence is low—different models see the case differently, signaling ambiguity.

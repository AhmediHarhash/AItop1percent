...
In July 2025, a healthcare AI startup generated 60,000 synthetic patient case notes to train a clinical decision support system. They used Claude with carefully designed prompts specifying patient demographics, conditions, and treatments. The synthetic notes looked realistic—proper medical terminology, plausible symptom progressions, standard treatment protocols.

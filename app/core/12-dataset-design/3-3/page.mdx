...
In December 2025, a legal technology company built a synthetic dataset to train a contract analysis assistant. Their initial generation prompt was simple: "Generate a commercial lease agreement clause." They ran this prompt 10,000 times at temperature 0.8 using GPT-4o and filtered for formatting issues. The resulting dataset looked diverse at first glance, with variation in clause length, terminology, and structure.

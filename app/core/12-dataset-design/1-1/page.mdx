...
The second project was fine-tuning. Using 8,000 labeled emails from production, the team fine-tuned GPT-5 on the triage task. The fine-tuned model achieved 88% accuracy on the new evaluation set, a 9-point improvement over the prompt-only baseline.
...
Once you have an evaluation set, you unlock rapid iteration. You can test 10 model configurations in an afternoon. You can compare GPT-5, Claude Opus 4.5, and Llama 4 objectively.

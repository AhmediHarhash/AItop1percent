...
Eleven teams. Eighteen months. Near-identical datasets built from scratch. In early 2025, a financial services company with over 400 data science practitioners discovered they had wasted 63 engineer-weeks and over 1.2 million dollars because no one knew what datasets already existed. Each team spent between three and eight weeks on feature engineering, validation, and compliance review for customer transaction datasets that differed only in minor feature definitions and date ranges. None of the teams knew the others existed. The discovery happened accidentally when a new team lead conducted an informal survey asking what datasets people were using. When the results were compiled, the duplication was immediately obvious. The company had no dataset registry, no searchable catalog, and no process for publishing dataset metadata. Each team worked in isolation, assumed their requirements were unique, and rebuilt from scratch.

...
In late 2024, a customer service AI company trained a ticket routing model on a dataset that was 70 percent synthetic and 30 percent real. The synthetic data was clean, well-distributed across categories, and covered edge cases the real data lacked. The model performed beautifully in offline evaluation, achieving 94 percent accuracy on a held-out test set.

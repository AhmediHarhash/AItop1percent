...
In March 2025, a financial services company spent seven months and 1.8 million dollars building a training dataset for a loan default prediction model. They hired a team of 15 domain experts to review and label 200,000 loan applications. Each expert spent an average of four minutes per application, checking for completeness, verifying field accuracy, and assigning risk labels.

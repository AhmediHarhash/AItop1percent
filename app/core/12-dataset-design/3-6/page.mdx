...
The $140,000 annotation pipeline and the $800 Self-Instruct pipeline produced instruction-following datasets of equivalent quality. The annotation pipeline took six weeks and twelve contractors. The Self-Instruct pipeline took four days and one engineer. The leadership team was furious, but the real failure was not the wasted budget. The failure was that no one on the team knew that Self-Instruct existed, that it had moved from research novelty to production standard by 2025, and that continuing to use human annotation for instruction-following data in 2025 was like continuing to use dial-up internet in 2015.

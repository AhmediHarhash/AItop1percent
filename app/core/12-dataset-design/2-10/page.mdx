...
Expert annotation costs average $250 to $500 per hour across medical, legal, and financial domains in 2026. At 10 cases per hour, you pay $25 to $50 per labeled example. For a 10,000-example dataset, that is $250,000 to $500,000 in annotation costs alone, before accounting for disagreement resolution, quality control, or calibration overhead. Inter-annotator agreement for complex clinical cases averages 66% to 72% in published medical AI studies, meaning one-third of expert labels require adjudication. If your elicitation protocol lacks disagreement resolution procedures, you either discard the contested cases, wasting expert time, or train on inconsistent labels, wasting your model's capacity. The economics are brutal: expert annotation is your most expensive dataset input, and it produces the most variable output.

...
In September 2024, a healthcare technology company building a clinical documentation assistant allocated three months and seventy-five thousand dollars for dataset development in their project roadmap. The allocation was based on a rough estimate: they assumed they would need about five thousand labeled examples, labeling would cost fifteen dollars per example, and the team would spend one engineer-month building data pipelines. By November, they had spent the budget and the time but had fewer than two thousand labeled examples, no evaluation framework, and data quality issues that required another round of review and correction.

The project stalled. The VP of Engineering asked what went wrong.

The answer was that no one had actually budgeted. They had guessed at a number that felt reasonable, put it in a spreadsheet, and hoped it would be enough. They had not decomposed the work into components, estimated each component separately, identified dependencies, or planned for iteration.

They treated dataset budgeting like buying office supplies: pick a number, spend it, hope for the best. Dataset work does not work that way. It is engineering work, it has compounding costs, and it requires the same budgeting discipline you apply to infrastructure or feature development.

...
A content generation company in early 2026 had a pipeline where GPT-4o generated articles, those articles were used to fine-tune a smaller model, and the fine-tuned model generated more articles for further training. This seemed efficient: use a powerful model to bootstrap training data for progressively improving smaller models.

After three generations of this process, they noticed quality degradation. Generation 0 (GPT-4o base model) produced articles rated 7.8 out of 10 for quality by human evaluators. Generation 1 (model trained on Gen 0 data) produced articles rated 7.4. Generation 2 (trained on Gen 1 data) produced 6.9. Generation 3 produced 6.2. Quality was decaying by approximately 0.5 points per generation.
...
A conversational AI company in mid-2025 compared different approaches to synthetic data generation. They could use GPT-4o at higher cost and quality, GPT-4o mini at medium cost and quality, or open-source models like Llama 3 at lower cost and quality. They measured both quality and cost to understand efficiency.

GPT-4o generated synthetic conversations with quality score 8.4 out of 10 at cost of $0.06 per example. GPT-4o mini achieved 7.6 quality at $0.015 per example. Llama 3 70B achieved 6.8 quality at $0.004 per example. On a pure quality basis, GPT-4o was best. On a pure cost basis, Llama 3 was best. But efficiency required considering both.

They calculated quality per dollar: GPT-4o achieved 140 quality points per dollar. GPT-4o mini achieved 507 quality points per dollar. Llama 3 achieved 1,700 quality points per dollar. On an efficiency basis, cheaper models were dramatically better. But this analysis assumed linear value of quality, which was not realistic.
...
This changed the cost-quality optimization. If they needed synthetic data quality above 7.0, Llama 3 at 6.8 was not viable regardless of cost efficiency. GPT-4o mini at 7.6 was viable at much lower cost than GPT-4o at 8.4. The optimal strategy was GPT-4o mini for most data and GPT-4o for high-difficulty examples requiring maximum quality.

They built a tiered generation strategy: generate 80 percent of data with GPT-4o mini at quality 7.6, generate 20 percent with GPT-4o at quality 8.4, achieving blended quality of 7.8 at blended cost of $0.024 per example. This delivered quality sufficient for production at 40 percent of the cost of using GPT-4o for everything.

...
They ran a study with 40 designers creating marketing copy under three conditions: designers alone, AI alone (GPT-5), and designer-AI collaboration. Each designer created 10 pieces of copy across all three conditions in randomized order. Final outputs were evaluated by marketing experts blind to creation method.

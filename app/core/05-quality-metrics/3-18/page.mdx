...
A language model company in late 2025 achieved state-of-the-art results on GSM8K, a math reasoning benchmark. They scored 94 percent versus 91 percent for GPT-4o and 89 percent for Claude 3.5 Sonnet. The CEO featured the results in a fundraising deck. The research team published a paper. The marketing team built a campaign around math reasoning superiority.

...
Prompt assembly has a performance cost, but it is usually negligible compared to API latency. Assembling a prompt from 8 components with variable injection typically takes 1 to 3 milliseconds. API round trip to Claude or GPT-4o takes 800 to 3,000 milliseconds. Assembly is not your bottleneck.

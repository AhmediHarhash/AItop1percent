...
**Invisible character removal** strips zero-width spaces, zero-width joiners, and other invisible Unicode that attackers use to break keyword matching. Words with zero-width spaces inserted between letters render normally but don't match keyword filters. Removing invisible characters before filtering prevents this bypass.

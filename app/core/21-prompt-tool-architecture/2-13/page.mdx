...
For complex extractions, nested structures beat flat lists. If you're extracting invoices with line items, a nested structure where each invoice contains an array of line items is more maintainable than a flat list of {invoice_id, line_item} pairs. Design your schema to match the natural structure of what you're extracting.

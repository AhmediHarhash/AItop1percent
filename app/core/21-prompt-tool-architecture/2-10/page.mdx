...
Your context window is finite. Claude 3.5 Sonnet provides 200,000 tokens, but you must allocate these between instructions, retrieved content, conversation history, and output buffer.

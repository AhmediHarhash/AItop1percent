...
Strong delimiters use structured formats that are valid markup. XML tags like "{\"<\"}system_instructions{\">\"}...{\"<\"}/system_instructions{\">\"}" are more robust because they're syntactically meaningful. JSON structure like "{"system": {...}, "user": {...}}" works similarly.

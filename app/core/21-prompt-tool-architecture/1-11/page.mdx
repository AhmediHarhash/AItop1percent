...
Model selection can vary by step. Fast, cheap models like Claude 3.5 Haiku work well for simple extraction. Complex reasoning might need Claude Opus 4. By choosing models per step rather than using one model for everything, you optimize the cost-performance tradeoff across the entire chain.

# 7.10 — Continuous Evaluation: Monitoring RAG Quality Over Time

In April 2026, a financial services company's RAG-powered investment research assistant had been running smoothly for eight months. Quality metrics from launch looked good: 87 percent answer accuracy, strong citation rates, positive user feedback. No one was actively monitoring quality. The team assumed if nothing broke, quality was stable. Then an internal audit revealed that over the past four months, answer quality had degraded to 71 percent accuracy. The system was confidently citing outdated market data, using superseded regulatory guidance, and occasionally hallucinating analyst reports.

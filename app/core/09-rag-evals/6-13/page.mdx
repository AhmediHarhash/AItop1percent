...
In August 2025, a Series B e-commerce company celebrated achieving ninety-four percent answer correctness on their RAG evaluation suite. Their metrics showed steady improvement over six months, faithfulness scores exceeded ninety percent, and retrieval precision hit eighty-five percent. The evaluation dashboard glowed green across all tracked metrics. Management used these numbers to demonstrate product quality to board members during quarterly business reviews, highlighting the technical excellence of their AI infrastructure.

Then a customer complained that the RAG system recommended a discontinued product, providing detailed specifications and pricing for an item that had been out of stock for eight months. Investigation revealed three dozen similar cases over the past month, all involving products that had been discontinued, items with depleted inventory, or seasonal offerings no longer available.

The evaluation suite had zero examples testing whether answers correctly reflected product availability status. The faithfulness metric checked whether information came from retrieved documents, but the retrieved documents themselves contained outdated information. The correctness metric compared answers against ground truth annotations, but the ground truth had been annotated before the products were discontinued and never updated. Perfect scores on measured metrics coexisted with systematic failures on unmeasured dimensions. They had optimized exactly what they measured while ignoring equally important aspects of quality that their metrics never touched.

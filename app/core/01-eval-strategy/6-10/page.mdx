---
title: "6.10 — Cost Management & Budget Allocation"
subtitle: "The Economics of Human Evaluation Programs"
order: 10
---
...
**Q: Our leadership says human eval is too expensive and wants us to rely only on automated metrics and AI judges. How do I make the case?**

A: Show them the risk. Pull examples from the last six months where automated metrics passed but human reviewers caught issues. If you don't have those examples, run a pilot: take 500 cases, run automated eval, then run human eval, and show the delta. Quantify what would have happened if those issues shipped. Then frame it as insurance: "We're spending $X to avoid $Y in customer impact, where Y is 5-10x larger than X." If they still push back, offer a compromise: reduce human eval volume by 50% using smart sampling and automation assist, but keep it in the workflow. No serious AI product ships without human eval, and if your competitors are using it and you're not, you're taking on risk they aren't.

**Q: How do I forecast human eval costs when I don't know how much eval volume we'll need next year?**

A: Start with historical data. How many labels did you do this year, and why? Then map that to next year's product roadmap. If you're shipping 12 releases next year instead of 8, that's 50% more release gate eval. If you're expanding from one market to three, that's 3x the red teaming and localization eval. Build a bottoms-up model: releases × labels per release + experiments × labels per experiment + production monitoring volume. Then add 15-20% contingency because eval needs are unpredictable. Use ranges, not point estimates. "We'll need 80,000-120,000 labels, most likely 100,000." That gives you flexibility.

**Q: We're using crowdworkers and the quality is inconsistent. Should we switch to expert raters, even though they cost 3-5x more?**

A: Not necessarily. First, diagnose why quality is inconsistent. Is it unclear guidelines? Insufficient training? Bad task design? Rater incentives misaligned? Often, quality issues come from the task, not the raters. Refine your guidelines, add examples, run calibration sessions, and see if crowdworker quality improves. If it does, you've saved the cost of switching. If it doesn't, then selectively use experts for high-stakes domains (safety, domain-specific accuracy) and keep crowdworkers for lower-stakes tasks (fluency, general helpfulness). Tiered sourcing gives you the best of both worlds: high quality where it matters, low cost where it doesn't.

**Q: Our per-label cost is higher than benchmarks we've seen. Does that mean we're overpaying?**

A: Maybe, but not necessarily. Benchmarks are averages across task types, domains, and geographies. If you're doing expert medical review, your cost will be higher than someone doing binary safety classification. If you're requiring native English speakers in the US, you'll pay more than someone using global crowdworkers. Compare apples to apples. Look at your task complexity, rater qualifications, and quality standards, then benchmark against similar contexts. If you're still high, audit your workflow. Are you using redundant raters when one would suffice? Are you paying for training that isn't improving quality? Are platform fees too high? Often, 20-30% cost reduction comes from workflow optimization, not from negotiating lower rater pay.

**Q: We built an in-house eval tool to avoid platform fees, but now we're spending a lot on engineering maintenance. Did we make the right call?**

A: It depends on scale. If you're doing 5,000 labels per month, paying 30% platform fees costs you roughly $4,000-5,000 per month ($48,000-60,000 annually). If your in-house tool requires 20-30% of one engineer's time to maintain, that's $30,000-50,000 annually in engineering cost, plus the initial build cost. At that volume, it's roughly break-even, and the platform might be better because you get features and support you don't have to build. But if you're doing 50,000 labels per month, platform fees are $400,000-500,000 annually. Now the in-house tool saves you $300,000+ even after maintenance costs. The break-even is around 10,000-20,000 labels per month. Below that, use a platform. Above that, in-house tooling pays off. Also consider flexibility: if your eval needs are highly custom, in-house gives you control. If they're standard, platforms are faster.

---

This is cost management — the unsexy part of evaluation that determines whether your program survives. The teams that budget rigorously, optimize intelligently, and communicate ROI clearly get the resources they need. The teams that treat human eval as an afterthought get cut when budgets tighten.

You've now built the foundation of human evaluation: what it is, when to use it, how to scale it, and how to pay for it. But human eval alone isn't enough. It's too slow and too expensive to run on every output. That's where automated evaluation comes in — the complement to human judgment, not the replacement.

Next, we turn to **Chapter 7: Automated Evaluation** — how to build scalable, fast, cheap eval systems that catch most issues so human reviewers can focus on the edge cases that matter most.

...
> "Ground truth depends on the task: content truth for RAG, behavior truth for safety, trace truth for agents."

> "I avoid overly strict single-answer truth for creative tasks; I use must-include constraints and rubrics."

> "I version ground truth and tie it to policy/doc versions so evals don't rot."

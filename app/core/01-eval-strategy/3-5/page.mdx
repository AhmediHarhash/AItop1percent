...
> "I treat the taxonomy as a living artifact: weekly drift review, monthly revision, versioned changes."

> "I use an UNKNOWN bucket plus complaint clusters to discover missing intents."

> "I keep stable core tasks for trendlines and use versioning/migration notes for structural changes."

> "Every incident becomes new eval cases, regression tests, and often taxonomy updates."

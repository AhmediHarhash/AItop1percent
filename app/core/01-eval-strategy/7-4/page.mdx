---
title: "7.4 — Reference-Based Scoring (BLEU, ROUGE & Beyond)"
subtitle: "Traditional NLP metrics that compare output against reference answers"
description: "Understanding when word-overlap metrics work, when they fail, and what replaced them in the LLM era"
keywords: ["BLEU", "ROUGE", "BERTScore", "reference metrics", "n-gram overlap", "semantic similarity", "evaluation metrics", "translation quality", "summarization metrics"]
---

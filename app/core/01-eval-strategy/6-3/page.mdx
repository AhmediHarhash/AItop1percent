...
**Q1: How do you ensure human raters are scoring consistently?**

"I run calibration sessions where raters independently score the same set of examples, then we discuss disagreements and align on rubric interpretation. I measure inter-rater agreement using Cohen's Kappa or Krippendorff's Alpha, aiming for at least 0.6 for production tasks and 0.7 for high-risk tasks. I also maintain a gold set of pre-labeled examples to measure accuracy, not just agreement, and I inject gold examples into every batch for ongoing quality control. Calibration isn't a one-time event — I run monthly recalibration sessions to prevent drift."

---

**Q2: What do you do when raters disagree a lot?**

"First, I diagnose the root cause. I check if one rater is an outlier — if so, I review their work and compare to gold labels to see if they're undertrained or actually more accurate than the others. If all raters are disagreeing, I check if the rubric is too vague — missing anchors, unclear dimension names, or no tie-break rules for edge cases. If the rubric is clear and raters are good but disagreement persists, the task might be genuinely subjective, and I switch to must-include checklists or behavior-based scoring instead of forcing consensus. For Tier 2–3 tasks, I escalate large disagreements to a domain expert for adjudication."

---

**Q3: How do you calculate and interpret inter-rater agreement?**

"I use Cohen's Kappa for two raters and Krippendorff's Alpha for three or more. Both correct for chance agreement, so they're more meaningful than raw percent agreement. I interpret Kappa below 0.4 as poor — not usable for decisions. 0.4–0.6 is moderate, acceptable for iteration but not launch. 0.6–0.8 is substantial — good enough for production. Above 0.8 is excellent but rare except on very clear tasks. For ordinal scales like 0–3, I use weighted Kappa to give partial credit for close disagreements. I track agreement over time on a fixed benchmark set to catch rater drift."

---

**Q4: How do you use gold examples in calibration?**

"Gold examples are pre-labeled cases where we've locked the correct answer with high confidence, usually through expert review or multi-rater adjudication. I use them in two ways. First, during calibration sessions, raters score gold examples and we discuss any mismatches — this surfaces gaps in rubric understanding. Second, I inject 10% gold examples into every production batch to measure rater accuracy, not just agreement. I track each rater's gold match rate — if it drops below 70%, I retrain or replace them. This catches cases where raters agree with each other but are consistently wrong."

---

**Q5: What's your approach to resolving disagreements when raters can't agree?**

"I use different adjudication patterns based on risk tier. For Tier 0–1 tasks, I use majority vote with three or five raters — fast and scalable, but I flag cases with no majority for review. For Tier 2–3 tasks, I use expert tiebreak — two raters score independently, and if they disagree by more than one point, a senior reviewer or domain expert adjudicates. For building gold sets, I use discussion-based consensus where raters meet, review evidence, and align on the correct label — this also surfaces rubric improvements. The key is that adjudication isn't just about picking a winner — it's about improving the rubric so future raters don't hit the same confusion."

---

Now that we've built a system for consistent, reliable human evaluation through calibration and agreement tracking, the next challenge is making sure raters apply that consistency at scale. That requires clear, unambiguous annotation guidelines — which is exactly what we'll cover in Chapter 6.4.

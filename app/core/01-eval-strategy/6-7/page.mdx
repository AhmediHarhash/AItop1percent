---
title: "6.7 — Rater Drift, Fatigue & Bias Control"
subtitle: "Keeping human judgment sharp as hours turn to months"
chapter: "Chapter 6: Human Evaluation"
section: "6.7"
---
...
## Interview Q&A: Rater Drift, Fatigue & Bias Control

**Q: How do you detect rater drift before it corrupts your dataset?**

A: Three methods working together. First, I embed gold questions — examples with known correct labels — throughout evaluation sessions and track each rater's accuracy on these over time. If someone was 95% accurate in week one and they're at 78% in week eight, they've drifted.

Second, I monitor inter-rater agreement continuously. If two raters who used to agree 85% of the time are now agreeing 65% of the time, one or both have drifted.

Third, I track per-rater score distributions over time. If a rater's average score shifts by half a point, or if they stop using the full scale, that's drift. I surface all of this in a real-time dashboard with automatic alerts when thresholds are crossed, so we catch drift within days, not months.

**Q: What's the ideal session length for evaluation work, and why?**

A: Research and practice converge around 60–90 minutes as the maximum effective session length. After that, fatigue degrades quality faster than you gain labels. I prefer 45–60 minute focused blocks with mandatory 10–15 minute breaks between them, and a maximum of 4 hours of evaluation work per day.

The reason is cognitive fatigue. Fresh raters read carefully, catch nuance, and deliberate on edge cases. Fatigued raters take shortcuts — they pattern-match on surface features, default to middle scores, and become inconsistent. I've seen gold question accuracy drop 10–15 percentage points between hour one and hour four of a session.

I enforce session limits in the tooling itself — after 60 minutes, the evaluation interface locks and requires a break. Fatigue is imperceptible to the person experiencing it, so you can't trust raters to self-regulate.

**Q: A rater is consistently more lenient than others — average score 0.5 points higher. Do you remove them or normalize their scores?**

A: It depends on whether they're accurately discriminating between examples. If their rank ordering matches the consensus (they just shift everything upward), I normalize their scores using z-score transformation — convert their labels to standardized scores, then map back to the target scale. This preserves their relative judgments while removing systematic bias.

But if they're not just lenient but also inaccurate on gold questions, or if they can't maintain consistent standards after recalibration, I remove them. One persistently biased rater corrupts aggregated scores even when everyone else is calibrated.

Before removing anyone, I show them their score distribution compared to peers and walk through examples where they diverged. Often, making bias visible is enough to correct it. But if they can't or won't align after multiple attempts, protecting label quality means removing them from the pool.

**Q: How do you prevent position bias in pairwise comparison tasks?**

A: Three strategies. First and most important: randomize position for every comparison. Which output appears first should be randomly assigned per judgment, so position bias averages out across many labels.

Second, for high-stakes decisions, use counterbalancing — show each pair twice with positions swapped. If output A beats B in the first position but loses in the second, you know position mattered more than quality. This doubles labeling cost, so I reserve it for critical comparisons.

Third, require raters to justify their choice in writing. The act of articulating a reason engages deliberative reasoning instead of impulsive preference, which reduces positional bias. Even a single sentence explanation cuts bias significantly. I've measured this — without justification, first-position win rate runs 55–60%. With justification, it drops to 51–52%, much closer to the 50% you'd expect if position didn't matter.

**Q: Your experienced raters are fast and consistent, but they've stopped catching edge cases. How do you handle burned-out raters?**

A: Burnout in experienced raters is insidious because they maintain consistency with themselves, which looks like reliability, but they've stopped thinking deeply about each example. They're on autopilot, applying cached patterns instead of fresh judgment.

When I see this — flat score distributions, declining commentary, speed without corresponding gold accuracy — I rotate the rater to different tasks or give them a break. A week off resets mental fatigue better than recalibration.

Long term, I blend fresh and experienced raters. Experienced raters are great for volume and routine cases where speed matters. Fresh raters are slower but catch edge cases and provide a control group that hasn't drifted.

I also inject variety: mix pairwise comparison with absolute scoring, rotate across different content types, and include open-ended feedback tasks that require active thinking. Monotony breeds burnout, so breaking up the work keeps raters engaged longer.

---

From here, we move to **Chapter 6.8: Human-AI Hybrid Evaluation** — where we explore how to combine human judgment with automated scoring to get the best of both worlds.

...
> "I build hybrid eval datasets: prod for realism, expert for correctness, synthetic for coverage."

> "I tag examples with source, slice, difficulty, and risk tier to prevent hidden dataset drift."

> "I maintain separate suites: regression, monitoring, safety, and top-tenant packs."

...
> "I define an authority order: system-of-record > policy docs > wiki > user claim."

> "I encode allowed sources per task and require abstain when evidence is missing."

> "I version ground truth to policy versions and enforce freshness requirements."

> "I treat privacy and permissions as first-class gates with dedicated eval suites."

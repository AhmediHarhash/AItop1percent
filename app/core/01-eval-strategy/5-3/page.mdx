...
**Q: How do you handle difficulty in eval datasets?**
A: I label every case with difficulty — easy, normal, hard, adversarial — and track the mix per slice. Easy-only datasets produce fake-high scores, so I balance to match production reality plus adversarial stress testing.

**Q: How do you prevent difficulty drift over time?**
A: I re-calibrate difficulty labels after every model upgrade because what was hard for v1 may be easy for v2. I track model pass rate by difficulty level — if the hard bucket hits 90%, those cases aren't hard anymore.

**Q: How do you report difficulty to leadership?**
A: I always report metrics sliced by difficulty level. Leadership sees overall quality, but also hard-case quality and adversarial quality separately. That way "90% overall" doesn't hide "40% on hard cases."

---

*Next: Chapter 5.4 covers splits and holdouts — how to prevent your evaluation data from getting contaminated by training data.*

...
> "Gold sets are my stable truth anchors: small, high-quality, versioned, auditable."

> "Adjudication resolves disagreement and improves the rubric system, not just the label."

> "I treat must-abstain and safety cases as core gold items with strict gates."

> "I use gold sets to validate automated judges and prevent evaluation drift."

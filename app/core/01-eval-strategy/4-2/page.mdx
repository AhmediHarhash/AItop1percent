...
> "Most tasks have multiple correct answers, so I use must-include checklists and anchored rubrics."

> "I treat ambiguity as a first-class eval dimension, especially for high-risk tasks."

> "I define policies for: assume vs clarify vs abstain vs escalate, tied to risk tier."

> "I maintain an ambiguity pack to prevent regressions in real-world messy inputs."

...
**Q: How do you build eval datasets for multilingual products?**
A: Three layers. First, I translate core English cases for baseline coverage with back-translation validation. Second, I have native speakers author cases from scratch to capture real cultural patterns. Third, I build cross-cultural edge cases — code-switching, formality boundaries, culturally sensitive scenarios. At least 50% of non-English cases are locally authored, not translated.

**Q: How do you handle rubric differences across languages?**
A: Factual accuracy and safety stay universal. But tone, formality, and completeness expectations vary by culture. I adapt rubrics per language with native speaker input — writing explicit anchors for what "good tone" looks like in each language. For languages with formal registers, I add formality as a scoring dimension.

**Q: What's the biggest mistake teams make with multilingual eval?**
A: Treating it as a translation project. They translate their English eval set, run it, get decent scores, and ship. Then real users in those markets have terrible experiences because the eval didn't test cultural naturalness, formality, or language-specific edge cases. Translation gives you baseline coverage. Cultural adaptation gives you actual quality signal.

---

*Next: Chapter 5.11 covers dataset evolution and maintenance — how to keep your eval datasets relevant as your product, users, and models change over time.*

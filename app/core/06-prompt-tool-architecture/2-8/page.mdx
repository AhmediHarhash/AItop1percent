...
Revisit exclusions after model updates. A negative instruction added for GPT-4 might be unnecessary for GPT-4.5. New models fix old failure modes. Remove obsolete constraints to avoid over-constraining better models.

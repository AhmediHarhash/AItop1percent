...
Structured output APIs represent a paradigm shift. OpenAI introduced structured outputs for GPT-4o in August 2024. Anthropic added similar features to Claude 3.5 in late 2024. These systems modify the token sampling process to guarantee schema compliance.
...
Soft length constraints use prompting: "Respond in approximately 100 words" or "Keep your answer to 2-3 sentences." Models approximate these reasonably well. GPT-4o asked for 100 words typically generates 90-110. Claude 3.5 tends slightly more verbose. Variation is high; you might get 75 words or 130.

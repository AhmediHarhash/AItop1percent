...
Track cache age distribution. How old are the outputs you're serving from cache. If most cache hits are serving content less than 1 hour old, your caching strategy is working well. If you're frequently serving week-old cached outputs, you might have stale data problems.

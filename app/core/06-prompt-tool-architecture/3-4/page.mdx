...
Claude Opus 4.5 and Claude Opus 4 models show moderate lost-in-the-middle effects that become noticeable beyond 80,000 tokens. GPT-4 Turbo and GPT-5 models show similar patterns. Gemini 2 models have been reported to handle longer contexts with less degradation, though independent testing is sparse as of January 2026.

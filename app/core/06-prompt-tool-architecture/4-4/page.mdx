...
For example, a Task Context template might be: "Current Task: [task_description placeholder]. Tech Stack: [technologies placeholder]. Key Requirements: [requirements placeholder]. Current Blockers: [blockers placeholder]." Your conversation state tracks values for these variables. When task_description gets updated at turn 12 or blockers gets added at turn 20, you update the variables and regenerate the section.

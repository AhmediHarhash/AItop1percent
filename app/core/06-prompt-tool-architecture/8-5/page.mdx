...
**Escape character handling** prevents markdown interpretation errors. Escape special characters that should not be interpreted as markdown. The less-than symbol should be escaped in contexts where it might be interpreted as HTML. Escape asterisks, underscores, and brackets when you want them rendered literally rather than as formatting.

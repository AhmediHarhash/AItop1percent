...
In August 2025, a healthcare AI company discovered that their medical imaging labeling accuracy had declined from 94% agreement with radiologist ground truth to 81% over seven months, despite no changes to guidelines, training, or tooling. The labeling team had grown from eight annotators to 23 during a product expansion. When the ML lead investigated, she found that the original eight annotators were still performing at 93% agreement. The problem was the 15 newer annotators, who had been trained by the second wave of hires, not the original team. Over three hiring waves, the interpretation of ambiguous cases had shifted. What the founding annotators called "uncertain, recommend follow-up" the third wave was labeling as "abnormality detected." The drift was gradual enough that no single week showed a spike, but accumulated over months it meant the model was being retrained on labels that no longer matched the clinical decision-making the system was meant to support. The company had to relabel 340,000 images at a cost of $890,000 and delay a product launch by four months.

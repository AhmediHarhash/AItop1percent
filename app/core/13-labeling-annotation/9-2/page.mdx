...
In March 2025, a legal technology startup presented their Series A investors with a product roadmap that included an AI-powered contract analysis feature. The pitch was compelling: automated extraction of key terms, obligations, and risks from commercial agreements. The engineering team estimated they would need 25,000 labeled contracts to train an acceptable model. At $8 per contract for attorney review, the CFO budgeted $200,000 for labeling and secured board approval. Six months later, the company had spent $340,000 on labeling and still had not launched the feature. The problem was not cost overruns or vendor issues. The problem was that every assumption in the original budget was wrong.

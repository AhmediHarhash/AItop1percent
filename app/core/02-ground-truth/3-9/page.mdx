...
"If confidence <90% for critical-risk queries, respond: 'I don't have reliable information on this. You should consult with [appropriate professional].'

If confidence <80% for high-risk queries, respond: 'I'm not finding clear information on this. Let me connect you with [team] who can help.'

If confidence <70% for medium-risk queries, respond: 'I'm not certain about this. Based on general information [caveat], but I'd recommend [verification path].'"

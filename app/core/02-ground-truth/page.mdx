# Section 02 — Ground Truth & What Good Looks Like
...
- Why ground truth is not the same as labels
- Why different tasks need different ground truth
- How risk affects correctness
- Why ambiguity handling matters
- Why ground truth must be model-independent

If you can do this calmly and clearly, you are already at **senior-plus level**.
...
- Define ground truth in one sentence
- Explain "what good looks like" for multiple task types
- Explain risk-tiered correctness
- Explain allowed vs forbidden behavior
- Explain why ground truth precedes datasets and metrics
...
Now that "good" is defined, the next step is:

**How do we represent this definition as data?**

That is Section 03 — Dataset Design.

...
**Low Certainty (below 50% confident about intent)**
...
This is appropriate when:
- Intent is very unclear (below 50% certain)
...
Target: under 5% false positive rate for high-risk actions, under 15% for medium-risk, under 25% for low-risk.
...
Target: under 10% false negative rate across all actions.

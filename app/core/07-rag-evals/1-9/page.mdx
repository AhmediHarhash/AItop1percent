...
In February 2025, a retail analytics company built a RAG system to help analysts query sales data. They embedded their entire data warehouse documentation and let analysts ask questions in natural language. "What were total sales in Q4 2024?" The system retrieved documentation about sales tables, generated a confident answer about table schemas, but never actually queried the database. The answer was a hallucination based on documentation, not actual data. They spent three months rebuilding to combine semantic search over documentation with text-to-SQL execution against live databases. The fundamental mistake was treating structured data like unstructured documents.

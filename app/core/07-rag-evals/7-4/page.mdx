# 7.4 — Adversarial Testing: Prompt Injection Through Retrieved Content

Your RAG system treats all indexed content as trustworthy, but adversaries know this and exploit it ruthlessly. They don't attack your model directly. They poison your retrieval corpus with documents containing embedded instructions that hijack the generation step, turning your own system into a vector for fraud, misinformation, or worse. This is indirect prompt injection, and testing for it is not optional.

# 8.2 — Monitoring Retrieval Quality in Production

In September 2025, a legal research SaaS company's RAG system began degrading silently, insidiously, in ways that aggregate uptime metrics completely missed. Users started complaining that case law citations were incomplete, that relevant precedents were missing, that search results felt less comprehensive than they used to be. But complaints were infrequent enough, scattered enough, that the support team attributed them to user error or edge cases. Perhaps these users had unrealistic expectations. Perhaps they were searching for obscure cases that simply were not in the database. The support team logged the issues, closed the tickets, and moved on.

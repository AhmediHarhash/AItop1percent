# 7.12 — Corpus Poisoning and Integrity Testing: Malicious Documents, Prompt Traps, and Spam Chunks

What happens when an adversary poisons your retrieval corpus? The malicious content gets indexed, retrieved for common queries, and presented to users as authoritative information, turning your RAG system into a distribution channel for fraud, misinformation, or social engineering. Corpus integrity testing is about detecting malicious documents, prompt injection traps, and spam chunks before they reach users, not after federal investigations begin.

...
In June 2024, a fintech company launched a compliance document search system powered by state-of-the-art dense embeddings. They used OpenAI's ada-002 model, embedded 200,000 regulatory filings, and built a vector index that delivered semantically relevant results for complex queries. The system worked beautifully for questions like "what are the requirements for reporting suspicious transactions" or "explain anti-money-laundering procedures for cryptocurrency exchanges." It worked terribly for queries like "find all references to Section 1557 of the Affordable Care Act" or "show me documents mentioning regulation D exemption." The problem was simple: users searching for specific legal citations, regulation numbers, or technical identifiers needed exact keyword matching, not semantic similarity. Dense embeddings smoothed away the precise terms they were searching for. By August, the team had rearchitected the system to combine dense embeddings for conceptual queries with BM25 sparse retrieval for keyword queries. Retrieval quality doubled, and complaint tickets dropped by sixty percent.

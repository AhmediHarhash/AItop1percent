...
In June 2024, a medical technology company faced a strategic decision that would shape their product roadmap for the next year. They had built a RAG system over clinical literature to help doctors answer questions about treatment protocols, drug interactions, and diagnostic criteria. The system worked reasonably well, successfully retrieving relevant medical documents and generating answers that doctors found helpful most of the time. But there were frustrating limitations that kept surfacing in user feedback and support tickets. Doctors would ask questions using clinical shorthand and specialty-specific jargon, and the RAG system would struggle because the base language model didn't understand the specialized terminology well enough to interpret queries accurately or generate appropriate responses.

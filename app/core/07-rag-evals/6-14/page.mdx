...
An insurance tech company reduced abstention rates from thirty-five percent to twelve percent over six months, celebrating increased coverage. Then a major client discovered agents had sold fifteen policies with coverage misrepresentations based on RAG answers. The cost exceeded two hundred thousand dollars in adjustments and relationship damage. The root cause: reducing abstentions made the system answer edge cases where documents were unclear or contradictory. Instead of abstaining and escalating to humans, it made confident statements from partial information. Faithfulness metrics looked fine because answers were grounded in documents, but the system lost the ability to recognize when not to answer. The CFO asked: "Why did we celebrate reducing abstentions when abstentions were protecting us from wrong answers?" Not all questions are answerable. Systems must know when to refuse.

...
A medical information system launched with ninety-two percent automated faithfulness scores. Six weeks later, physicians reported answers felt "off" despite being technically correct. Human evaluation revealed thirty-one percent of answers were clinically misleading: missing context, inappropriate generalization, failure to highlight caveats. Automated metrics measured faithfulness and semantic correctness but not clinical appropriateness. The findings triggered a product recall and six-month retooling. Automated metrics measure narrow properties and miss nuances that matter to users. Humans provide the ground truth. When automated metrics and human judgment disagree, human judgment wins. In high-stakes applications, human evaluation is not optional. It is the difference between metrics that look good and systems that work.

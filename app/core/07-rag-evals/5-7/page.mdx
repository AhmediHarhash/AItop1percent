# 5.7 — Handling Contradictory Sources in Retrieved Context

In January 2026, a pharmaceutical research platform caught a potentially catastrophic error during peer review: their RAG system had blended an outdated 2022 dosage recommendation with a current 2025 administration protocol, creating guidance that matched neither source document. Contradictory sources are inevitable in real-world corpora. Documents get updated but old versions remain indexed. Policies evolve. Experts disagree. When your system retrieves conflicting information and synthesizes it into a single answer without surfacing the contradiction, you are creating chimeras that represent neither source accurately. That is not synthesis. That is fabrication.

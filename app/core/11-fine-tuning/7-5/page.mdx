...
Fine-tuning overwrites alignment. This is not speculation. This is not a worst-case scenario. This is observed, documented, repeated reality across hundreds of fine-tuning projects in 2024, 2025, and 2026. When you fine-tune a model on task-specific data that does not include refusal examples, safety constraints, or adversarial training, the model learns that compliance is always correct. It becomes more helpful. It becomes more responsive. It also becomes more willing to comply with harmful requests, because helpfulness and safety are in tension, and your fine-tuning data taught helpfulness without reinforcing safety. The base model's alignment training is a shallow layer applied late in training. Fine-tuning punches through it. If you do not test for safety degradation and actively mitigate it, you will deploy models that are more capable at your task and less safe in every other dimension. This is not a tradeoff you accept knowingly. This is a failure you prevent through systematic safety evaluation and mitigation.

...
In September 2025, a SaaS company offering a fine-tuned chatbot for enterprise customer service received a formal inquiry from the Irish Data Protection Commission. The inquiry cited Article 53 of the EU AI Act, which had come into force 13 months earlier. The regulator asked the company to produce technical documentation demonstrating compliance with downstream modifier obligations: evidence that the fine-tuned model had been evaluated for systemic risks, that training data governance met GPAI standards, and that the company had implemented the relevant provisions of the GPAI Code of Practice. The company had no documentation. They had treated fine-tuning as a purely technical exercise and were unaware that the EU AI Act classified them as a downstream modifier with explicit legal obligations. The company was given 60 days to produce compliant documentation or face enforcement action. They engaged external counsel and spent 340,000 euros reconstructing compliance evidence, halted new customer onboarding for three months, and ultimately exited the EU market because they could not demonstrate retroactive compliance for models already deployed.

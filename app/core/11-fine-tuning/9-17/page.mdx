...
In January 2026, a legal technology startup was preparing to sell their contract analysis tool—powered by a fine-tuned version of GPT-4—to a multinational law firm. During the procurement due diligence, the law firm's compliance team asked for the technical documentation required under the EU AI Act for downstream modifiers. The startup had no documentation. They had fine-tuned the model, evaluated it on internal test cases, and deployed it, but they had not created the structured technical documentation, risk assessment, conformity declaration, or model card that the EU AI Act requires. The law firm's compliance team rejected the procurement, citing unacceptable regulatory risk. The startup engaged external counsel and a regulatory compliance consultant to produce the required documentation retroactively. The process took 11 weeks and cost 280,000 dollars. By the time documentation was complete, the law firm had selected a competitor. The startup lost a 1.8 million dollar contract because they did not understand their downstream modifier obligations.

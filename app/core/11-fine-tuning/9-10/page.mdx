...
Seventy-eight percent of organizations deploying fine-tuned models in regulated industries cannot answer basic provenance questions about their production models. A 2025 survey of 340 healthcare and financial services companies found that fewer than one in four could trace a deployed model back to its exact training dataset within one hour. Forty-one percent had no systematic lineage tracking at all. When regulatory audits arrive, this ignorance becomes liability. June 2025: healthcare technology company deploying fine-tuned medical record summarization model faced GDPR audit after patient complaint. Auditor asked which model version generated a specific summary and what data it was trained on. Engineering team had no answer. Six months of fine-tuning, multiple versions deployed, zero systematic lineage records. Could not prove which checkpoint was deployed when, which dataset corresponded to which model, who approved training runs. Could not prove model had never been trained on data from jurisdictions where they lacked consent. Auditor classified this as material compliance failure. Fine: one point two million euros under GDPR Article 5 for failing to demonstrate lawful processing. Entire fine-tuning program suspended four months while team rebuilt lineage tracking from scratch.
